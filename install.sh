#!/usr/bin/env sh
# Universal installer for apiseclint. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/apiseclint.git"
echo "Installing apiseclint ..."
