"""Native cognis-connect emit for apiseclint — forward findings to any platform.

Maps apiseclint's JSON output to the canonical `Finding` and forwards it via
...
Usage:
    apiseclint ... --format json | apiseclint-emit --to stix
    apiseclint-emit --to slack --url $WEBHOOK --dry-run < findings.json
"""
